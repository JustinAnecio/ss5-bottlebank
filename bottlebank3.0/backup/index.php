...
$deposit = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) AS cnt, COALESCE(SUM(quantity),0) AS total_bottles, COALESCE(SUM(amount),0) AS total_amount FROM deposit"));
